...
export default function VoipPage() {
  const offerings = [
    {
      ...
      description: "Modern IP phone systems for crystal clear business communication.",
      number: "01",
    },
    {
      icon: PhoneCall,
      title: "Internal Extensions",
      description: "Connect all departments with internal extension numbers.",
      number: "02",
    },
    {
      icon: Network,
      title: "Call Routing",
      description: "Intelligent call routing to the right department every time.",
      number: "03",
    },
    {
      icon: Users,
      title: "Reception/Department Setups",
      description: "Professional reception and department phone configurations.",
      number: "04",
    },
    {
      icon: Globe,
      title: "Remote Extensions",
      description: "Stay connected from anywhere with remote extension capability.",
      number: "05",
    },
    {
      icon: Headphones,
      title: "Conference Calling",
      description: "Multi-party conference calling for team meetings.",
      number: "06",
    },
  ];
  ...
  const applications = [
    ...
    },
    {
      ...
      description: "Connect offices, security, workshops, and control rooms.",
    },
    {
      icon: Users,
      title: "Schools & Institutions",
      description: "Efficient communication for educational facilities.",
    },
    {
      icon: Globe,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-deep-blue-light/20 rounded-full px-4 py-2 mb-6">
                <Phone size={16} className="text-deep-blue-light mr-2" />
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Stay Connected.
                <br />
                <span className="text-deep-blue-light">Everywhere.</span>
                <br />
                Always.
              </h1>
              
              <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed">
                Professional phone systems that keep your business connected and
                your team communicating effectively.
              </p>
            ...
            >
              <div className="bg-deep-blue rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-white font-bold text-xl">Connected Communication</p>
                  <p className="text-gray-400 text-sm">Seamless business calls</p>
                </div>

                {/* Grid of communication features */}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                Let's discuss the best communication solution for your organization.
              </p>
              <Link href="/contact" className="btn btn-primary text-lg px-8 py-3.5">
