        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10 py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-white font-semibold">VOIP & Business Communication</span>
            </motion.div>
        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">
              Join organizations across Zimbabwe who trust Kavash for their communication needs.
            </p>
