  ...
  const offerings = [
    {
      ...
      description: "Biometric fingerprint access for secure and convenient entry.",
      number: "01",
    },
    {
      icon: ScanFace,
      title: "Facial Recognition",
      description: "Advanced facial recognition technology for hands-free access.",
      number: "02",
    },
    {
      icon: CreditCard,
      title: "RFID Cards",
      description: "Contactless RFID card access for employees and visitors.",
      number: "03",
    },
    {
      icon: Key,
      title: "Smart Locks",
      description: "PIN access and smart locks for enhanced security.",
      number: "04",
    },
    {
      icon: DoorOpen,
      title: "Automated Gates",
      description: "Sliding, swing, and boom barriers with remote control.",
      number: "05",
    },
    {
      icon: Smartphone,
      title: "Visitor Management",
      description: "Track and manage visitors with digital check-in systems.",
      number: "06",
    },
  ];
  ...
  const applications = [
    {
      icon: Building,
      title: "Businesses",
      description: "Secure access for offices and commercial buildings.",
    },
    {
      icon: Factory,
      title: "Industrial Sites",
      description: "Restricted area access for industrial facilities.",
    },
    {
      icon: School,
      title: "Schools",
      description: "Controlled access for educational institutions.",
    },
    {
      icon: Home,
      title: "Gated Communities",
      description: "Secure entry for residential communities.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-deep-blue-light/20 rounded-full px-4 py-2 mb-6">
                <Lock size={16} className="text-deep-blue-light mr-2" />
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Secure.
                <br />
                <span className="text-deep-blue-light">Controlled.</span>
                <br />
                Protected.
              </h1>
              
              <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed">
                Advanced access control systems that secure your property and
                manage who enters restricted areas.
              </p>
            ...
            >
              <div className="bg-deep-blue rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-white font-bold text-xl">Secure Access</p>
                  <p className="text-gray-400 text-sm">Multi-layer security</p>
                </div>

                {/* Grid of access methods */}
          ...
          <div className="space-y-0">
            {offerings.map((item, index) => (
              ...
              >
                ...
                <ArrowRight size={24} className="text-deep-blue opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" />
              </motion.div>
            ))}
          </div>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                Let's discuss the best access control solution for your needs.
              </p>
              <Link href="/contact" className="btn btn-primary text-lg px-8 py-3.5">
