        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10 py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-white font-semibold">Automation & Access Control</span>
            </motion.div>
            ...
            >
              Control Who
              <br />
              <span className="text-gray-300">Gets In</span>
            </motion.h1>
        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">
              Join property owners across Zimbabwe who trust Kavash for access control.
            </p>
