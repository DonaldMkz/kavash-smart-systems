  ...
  const offerings = [
    {
      ...
      description: "High-definition IP cameras for crystal clear video surveillance.",
      number: "01",
    },
    {
      icon: Video,
      title: "HD Cameras",
      description: "Full HD and 4K cameras for detailed video capture.",
      number: "02",
    },
    {
      icon: Moon,
      title: "Night Vision",
      description: "Infrared night vision for 24/7 surveillance capability.",
      number: "03",
    },
    {
      icon: Eye,
      title: "PTZ Cameras",
      description: "Pan-tilt-zoom cameras for wide area coverage and detail.",
      number: "04",
    },
    {
      icon: Monitor,
      title: "Remote Viewing",
      description: "View your cameras from anywhere on your phone or computer.",
      number: "05",
    },
    {
      icon: HardDrive,
      title: "NVRs & Video Storage",
      description: "Network video recorders with reliable storage solutions.",
      number: "06",
    },
  ];
  ...
  const applications = [
    {
      icon: Home,
      title: "Homes",
      description: "Protect your family and property with residential security.",
    },
    {
      icon: Building,
      title: "Offices",
      description: "Monitor your business premises and employees.",
    },
    {
      icon: Store,
      title: "Retail Stores",
    ...
    },
    {
      ...
      description: "Comprehensive surveillance for large industrial facilities.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-deep-blue-light/20 rounded-full px-4 py-2 mb-6">
                <Shield size={16} className="text-deep-blue-light mr-2" />
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                See Everything.
                <br />
                <span className="text-deep-blue-light">From Anywhere.</span>
                <br />
                Always.
              </h1>
              
              <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed">
                Professional surveillance systems for homes, businesses, and industrial
                sites with remote viewing capability.
              </p>
            ...
            >
              <div className="bg-deep-blue rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-white font-bold text-xl">24/7 Monitoring</p>
                  <p className="text-gray-400 text-sm">Always watching, always secure</p>
                </div>

                {/* Grid of security solutions */}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                Let's discuss the best security solution for your property.
              </p>
              <Link href="/contact" className="btn btn-primary text-lg px-8 py-3.5">
