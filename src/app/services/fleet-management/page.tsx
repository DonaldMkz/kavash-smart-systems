  ...
  const offerings = [
    {
      ...
      description: "Track your vehicles in real-time with precise GPS location monitoring.",
      number: "01",
    },
    {
      icon: Clock,
      title: "Trip History",
      description: "Complete trip history and route playback for all your vehicles.",
      number: "02",
    },
    {
      icon: MapPin,
      title: "Geofencing",
      description: "Set virtual boundaries and receive alerts when vehicles enter or leave designated areas.",
      number: "03",
    },
    {
      icon: Gauge,
      title: "Speed Monitoring",
      description: "Monitor vehicle speed and receive alerts for speeding violations.",
      number: "04",
    },
    {
      icon: User,
      title: "Driver Behavior Monitoring",
      description: "Track driver behavior including harsh braking, acceleration, and cornering.",
      number: "05",
    },
    {
      icon: FileText,
      title: "Fleet Reporting",
      description: "Comprehensive reports on fleet performance, usage, and efficiency.",
      number: "06",
    },
  ];
  ...
  const applications = [
    {
      ...
      description: "Complete fleet visibility and management for transport operations.",
    },
    {
      icon: Building,
      title: "Construction & Mining",
      description: "Track heavy equipment and vehicles across large sites.",
    },
    {
      icon: Car,
      title: "Logistics & Delivery",
      description: "Optimize routes and monitor delivery vehicles in real-time.",
    },
    {
      icon: Shield,
      title: "Security Companies",
      description: "Monitor response vehicles and ensure rapid deployment.",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-deep-blue-light/20 rounded-full px-4 py-2 mb-6">
                <Truck size={16} className="text-deep-blue-light mr-2" />
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Know Where.
                <br />
                <span className="text-deep-blue-light">Every Vehicle.</span>
                <br />
                Always.
              </h1>
              
              <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed">
                Real-time GPS tracking and fleet management solutions that give you
                complete control over your vehicles.
              </p>
            ...
            >
              <div className="bg-deep-blue rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-white font-bold text-xl">Live Tracking</p>
                  <p className="text-gray-400 text-sm">Real-time visibility</p>
                </div>

                {/* Grid of fleet methods */}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                Let's discuss the best fleet management solution for your business.
              </p>
              <Link href="/contact" className="btn btn-primary text-lg px-8 py-3.5">
