      ...
      <section className="relative min-h-screen bg-gradient-to-br from-deep-blue-dark via-deep-blue to-deep-blue-light flex items-center">
        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10 py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <Truck size={20} className="text-white mr-2" />
              <span className="text-white font-semibold">Fleet Management</span>
            </motion.div>
            ...
            >
              Know Where
              <br />
              <span className="text-gray-300">Every Vehicle Is</span>
            </motion.h1>
        ...
        <div className="container mx-auto px-6 md:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">
              Join businesses across Zimbabwe who trust Kavash for their fleet management needs.
            </p>
