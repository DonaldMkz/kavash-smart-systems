          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center bg-deep-blue-light/20 rounded-full px-4 py-2 mb-6">
                <HardHat size={16} className="text-deep-blue-light mr-2" />
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Built for.
                <br />
                <span className="text-deep-blue-light">Heavy Industry.</span>
                <br />
                Engineered.
              </h1>
            ...
            >
              <div className="bg-deep-blue rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-white font-bold text-xl">Industrial Grade</p>
                  <p className="text-gray-400 text-sm">Built for harsh environments</p>
                </div>

                {/* Grid of mining solutions */}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Ready to Power Your Industrial Operations?
              </h2>
              <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                Let's discuss the best industrial technology solution for your needs.
              </p>
              <Link href="/contact" className="btn btn-primary text-lg px-8 py-3.5">
